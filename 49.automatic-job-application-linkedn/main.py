#currently the program is only saving jobs.
#To apply for the jobs click on apply button instead of save
#Fill in the contact number and submit the application
#Also skip the complex forms
...
USERNAME = "mansiyadavaz126@gmail.com"
PASSWORD = "Universe00"
...
try:
    ...
    for i in range(15):
        ...
        #the jobs list has 4 same elements then the new one
        count += 5
